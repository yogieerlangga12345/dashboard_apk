  ...
  <div class="login-box">
      ...
      <div class="card-body login-card-body">
        ...
        <form id="form-loginn" onsubmit="login();return false">
          ...
          <div class="row">
            <!-- /.col -->
            <div class="col">
              <p><small><i>Belum Punya Akses Sebagai Pembimbing?</i><a href="register.php">Sign Up</a></small></p>
            </div>
            <div class="col">
    ...
    <script>
      function login() {
        ...
        if (t_email != null && t_pass != null) {
          Swal.close();
          firebase.auth().signInWithEmailAndPassword(t_email, t_pass).catch(function (error) {
          ...
          Swal.fire({
           icon: 'error',
           title: 'Oops...',
           text: "Your Email is not available or invalid"
         })
        }
      }
    </script>  
